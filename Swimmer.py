...
def main(render = True, train = False, alg = 'RARL', pm_pert = 0.0, frict = 1.0, model_to_load = '', heatmap = False):
    ...
    if alg in ['SAC', 'RARL_SAC']:
        ...
        player = {
            'policy': net.PolicyNetwork_SAC(n_inputs = 8, n_outputs=2),
            'Q1_target': net.SoftQNetwork_SAC(n_inputs = 8 + 2),
            'Q2_target': net.SoftQNetwork_SAC(n_inputs = 8 + 2),
            'Q1'    : net.SoftQNetwork_SAC(n_inputs = 8 + 2),
    ...
    if alg == 'RARL_SAC':
        rarl_sac = SAC_RARL.RARL_SAC(player, opponent, env, print_flag=False, lr_Q=3e-4, lr_pi=1e-4, name='Swimmer_Adversarial_SAC_model')
        ...
        sac = SAC_RARL.SAC(player['Q1_target'], player['Q2_target'], player['Q1'], player ['Q2'], player['policy'], env, print_flag=False, lr_Q=3e-4, lr_pi=1e-4, name='Swimmer_model_SAC')
